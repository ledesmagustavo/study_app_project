...
const {ThemeModel} = require('../../model/topic.model');
...
const listar = async function(req, res){
    ...
    const consultarPorCodigo = async function (req, res) {
        ...
        try {
            const topicsModelResult = await TopicService.consultarPorCodigo(req.params.id);
    ...
    const eliminar = async function (req, res) {
        ...
        try {
            await topic.TopicService.eliminar(req.params.id);
         res.json({
            success: true
         });
